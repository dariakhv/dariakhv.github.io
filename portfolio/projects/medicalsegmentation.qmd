...
date: "2025-06-26"
categories: [semantic segmentation, unet, dash, gcp]
image: "img/segmentation.png"
---
## Produc Overview
The data product is a dashboard designed to integrate seamlessly into a clinical engineer’s workflow for performing and evaluating semantic bone segmentations. The dashboard includes intuitive interface for the following components:
