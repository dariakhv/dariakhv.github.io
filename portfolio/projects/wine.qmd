...
date: "2024-12-15"
categories: [Docker, Machine Learning, Logistic Regression]
image: "img/wine.png"
---
...
### Inmportaint note:
The main focus of this project was to build a successful reproducible data science pipeline using Docker and Makefile. Pleach check out the GitHub Repo (linked above) to see the details on how to run the Docker container.
