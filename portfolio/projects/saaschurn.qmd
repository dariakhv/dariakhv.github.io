...
date: "2025-09-22"
categories: [analytics, database, Machine Learning, pipeline]
image: "img/saasretention.png"
---
[![](https://img.shields.io/badge/GitHub-%2312100E?style=for-the-badge&logo=github&logoColor=white)](https://github.com/dariakhv/saas_churn_subscription)
...
1. This is a synthetic study for portfolio purposes only. The data is a combination of [Kagle](https://www.kaggle.com/datasets/muhammadshahidazeem/customer-churn-dataset/data) dataset and synthetic data created by a random algorithm for invoices patterns and subscription tiers details, in order to simulate a **relational database** with pgAdmin (PostgreSQL).
...
6. **Monitoring:** Pipeline montoring with evidently package to check for any feature distribution drifts, and other data anomalies as new data is ingested on a defined cadence. `src/monitor.py`

Run the whole pipeline with `./run_pipeline.py`
...
**Basic**  
![](img/saasretention.png){width=80%}  
